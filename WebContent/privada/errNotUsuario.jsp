            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <!-- PENDIENE -->
							...
							<li class=""><a href="/Practica022/ReturnCuent?ced=<% out.print(ced); %>">Mi Cuenta</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center white">
            <h2 class="service-title pad-bt15">Error: El usuario no se encuentra registrado en el sistema</h2>
